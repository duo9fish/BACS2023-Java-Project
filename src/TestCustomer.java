...
public class TestCustomer {
    public static void main(String[] args) {
        ...
        while (adultQuantity < 0 || totalQuantity < adultQuantity) {    // validate because it must have the adult quantity that more than total quantity
        ...
        while (childQuantity < 0 || totalQuantity < childQuantity) {    // validate because it must have the children quantity that more than total quantity
            System.out.println("No negative number is allowed or unmatched to the total quantity");
            System.out.print("Enter Children quantity again: ");
        ...
        while (studentQuantity < 0 || totalQuantity != studentQuantity) {   // validate because it must have the student quantity that more than total quantity
            System.out.println("No negative number is allowed or unmatched to the total quantity");
